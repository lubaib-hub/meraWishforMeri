...
const sampleMessagesDataArray: TMessagesData[] = [
  {
    ...
    messageInParas: [
      "Hey there Riyah, it's your birthday! Wishing you the happiest of birthdays filled with all the things you love and cherish the most.",
      ...
      "You're a true gem, riii, and I feel lucky to know you. Happy birthday and cheers to a fantastic year ahead!",
    ],
  ...
  },
  {
    ...
    messageInParas: [
      ...
      "Once again, happy birthday, Rii! Cheers to another year of laughter, love, and wonderful memories.",
      "Warm regards,",
      "from Your Mad guy!",
    ],
