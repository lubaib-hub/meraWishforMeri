...
var require_util = __commonJS({
  "node_modules/node-vibrant/lib/util.js"(exports) {
    ...
    function hexToRgb(hex) {
      ...
      return m === null ? null : [m[1], m[2], m[3]].map(function(s2) {
    ...
    function rgbToXyz(r2, g, b) {
      ...
      g /= 255;
      b /= 255;
      r2 = r2 > 0.04045 ? Math.pow((r2 + 5e-3) / 1.055, 2.4) : r2 / 12.92;
    ...
    function rgbToCIELab(r2, g, b) {
      var _a = rgbToXyz(r2, g, b), x = _a[0], y = _a[1], z = _a[2];
    ...
    function getColorIndex(r2, g, b) {
      return (r2 << 2 * exports.SIGBITS) + (g << exports.SIGBITS) + b;
    }
    ...
    var Swatch = (
      ...
      function() {
        ...
        Object.defineProperty(Swatch2.prototype, "hsl", {
          get: function() {
            if (!this._hsl) {
              var _a = this._rgb, r2 = _a[0], g = _a[1], b = _a[2];
              this._hsl = util_1.rgbToHsl(r2, g, b);
            }
            return this._hsl;
          },
          enumerable: false,
        ...
        Object.defineProperty(Swatch2.prototype, "hex", {
          get: function() {
            if (!this._hex) {
              var _a = this._rgb, r2 = _a[0], g = _a[1], b = _a[2];
              this._hex = util_1.rgbToHex(r2, g, b);
            }
            return this._hex;
          },
          enumerable: false,
  ...
  "node_modules/node-vibrant/lib/builder.js"(exports) {
    ...
    var Builder = (
      ...
      function() {
        ...
        Builder2.prototype.maxColorCount = function(n2) {
          this._opts.colorCount = n2;
          return this;
        };
        ...
        Builder2.prototype.removeFilter = function(f) {
          var i2 = this._opts.filters.indexOf(f);
          if (i2 > 0)
            this._opts.filters.splice(i2);
          return this;
        };
      ...
      function() {
        ...
        VBox2.build = function(pixels, shouldIgnore) {
          ...
          while (i2 < n2) {
            ...
            g = g >> util_1.RSHIFT;
            b = b >> util_1.RSHIFT;
            var index = util_1.getColorIndex(r2, g, b);
            hist[index] += 1;
            if (r2 > rmax)
              rmax = r2;
            if (r2 < rmin)
        ...
        VBox2.prototype.count = function() {
          if (this._count < 0) {
            ...
            for (var r3 = r1; r3 <= r2; r3++) {
              for (var g = g1; g <= g2; g++) {
                for (var b = b1; b <= b2; b++) {
                  var index = util_1.getColorIndex(r3, g, b);
                  c2 += hist[index];
                }
              }
            }
        ...
        VBox2.prototype.contains = function(rgb) {
          ...
          var _a = this.dimension, r1 = _a.r1, r22 = _a.r2, g1 = _a.g1, g2 = _a.g2, b1 = _a.b1, b2 = _a.b2;
          r2 >>= util_1.RSHIFT;
          g >>= util_1.RSHIFT;
          b >>= util_1.RSHIFT;
        ...
        VBox2.prototype.split = function() {
          ...
          for (var i2 = 0; i2 < accSum.length; i2++) {
            var d = accSum[i2];
...
var require_mmcq = __commonJS({
  "node_modules/node-vibrant/lib/quantizer/mmcq.js"(exports) {
    ...
    var MMCQ = function(pixels, opts) {
      ...
      var pq = new pqueue_1.default(function(a2, b) {
        return a2.count() - b.count();
      });
      pq.push(vbox);
      _splitBoxes(pq, fractByPopulations * opts.colorCount);
      var pq2 = new pqueue_1.default(function(a2, b) {
        return a2.count() * a2.volume() - b.count() * b.volume();
      });
    ...
    function generateSwatches(pq) {
      ...
      while (pq.size()) {
        var v = pq.pop();
        var color = v.avg();
        var r2 = color[0], g = color[1], b = color[2];
...
var require_default = __commonJS({
  "node_modules/node-vibrant/lib/generator/default.js"(exports) {
    ...
    function _findMaxPopulation(swatches) {
      var p = 0;
      swatches.forEach(function(s2) {
        p = Math.max(p, s2.getPopulation());
      });
      return p;
    }
    ...
    function _findColorVariation(palette, swatches, maxPopulation, targetLuma, minLuma, maxLuma, targetSaturation, minSaturation, maxSaturation, opts) {
      ...
      swatches.forEach(function(swatch) {
        var _a = swatch.getHsl(), s2 = _a[1], l2 = _a[2];
        if (s2 >= minSaturation && s2 <= maxSaturation && l2 >= minLuma && l2 <= maxLuma && !_isAlreadySelected(palette, swatch)) {
          var value = _createComparisonValue(s2, targetSaturation, l2, targetLuma, swatch.getPopulation(), maxPopulation, opts);
    ...
    function _generateEmptySwatches(palette, maxPopulation, opts) {
      if (palette.Vibrant === null && palette.DarkVibrant === null && palette.LightVibrant === null) {
        if (palette.DarkVibrant === null && palette.DarkMuted !== null) {
          var _a = palette.DarkMuted.getHsl(), h = _a[0], s2 = _a[1], l2 = _a[2];
          l2 = opts.targetDarkLuma;
          palette.DarkVibrant = new color_1.Swatch(util_1.hslToRgb(h, s2, l2), 0);
        }
        if (palette.LightVibrant === null && palette.LightMuted !== null) {
          var _b = palette.LightMuted.getHsl(), h = _b[0], s2 = _b[1], l2 = _b[2];
          l2 = opts.targetDarkLuma;
          palette.DarkVibrant = new color_1.Swatch(util_1.hslToRgb(h, s2, l2), 0);
        }
      }
      if (palette.Vibrant === null && palette.DarkVibrant !== null) {
        var _c = palette.DarkVibrant.getHsl(), h = _c[0], s2 = _c[1], l2 = _c[2];
        l2 = opts.targetNormalLuma;
        palette.Vibrant = new color_1.Swatch(util_1.hslToRgb(h, s2, l2), 0);
      } else if (palette.Vibrant === null && palette.LightVibrant !== null) {
        var _d = palette.LightVibrant.getHsl(), h = _d[0], s2 = _d[1], l2 = _d[2];
        l2 = opts.targetNormalLuma;
        palette.Vibrant = new color_1.Swatch(util_1.hslToRgb(h, s2, l2), 0);
      }
      if (palette.DarkVibrant === null && palette.Vibrant !== null) {
        var _e = palette.Vibrant.getHsl(), h = _e[0], s2 = _e[1], l2 = _e[2];
        l2 = opts.targetDarkLuma;
        palette.DarkVibrant = new color_1.Swatch(util_1.hslToRgb(h, s2, l2), 0);
      }
      if (palette.LightVibrant === null && palette.Vibrant !== null) {
        var _f = palette.Vibrant.getHsl(), h = _f[0], s2 = _f[1], l2 = _f[2];
        l2 = opts.targetLightLuma;
        palette.LightVibrant = new color_1.Swatch(util_1.hslToRgb(h, s2, l2), 0);
      }
      if (palette.Muted === null && palette.Vibrant !== null) {
        var _g = palette.Vibrant.getHsl(), h = _g[0], s2 = _g[1], l2 = _g[2];
        l2 = opts.targetMutesSaturation;
        palette.Muted = new color_1.Swatch(util_1.hslToRgb(h, s2, l2), 0);
      }
      if (palette.DarkMuted === null && palette.DarkVibrant !== null) {
        var _h = palette.DarkVibrant.getHsl(), h = _h[0], s2 = _h[1], l2 = _h[2];
        l2 = opts.targetMutesSaturation;
        palette.DarkMuted = new color_1.Swatch(util_1.hslToRgb(h, s2, l2), 0);
      }
      if (palette.LightMuted === null && palette.LightVibrant !== null) {
        var _j = palette.LightVibrant.getHsl(), h = _j[0], s2 = _j[1], l2 = _j[2];
        l2 = opts.targetMutesSaturation;
        palette.LightMuted = new color_1.Swatch(util_1.hslToRgb(h, s2, l2), 0);
      }
    }
...
var require_default2 = __commonJS({
  "node_modules/node-vibrant/lib/filter/default.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function defaultFilter(r2, g, b, a2) {
      return a2 >= 125 && !(r2 > 250 && g > 250 && b > 250);
    }
  ...
  "node_modules/node-vibrant/lib/filter/index.js"(exports) {
    ...
    function combineFilters(filters) {
      if (!Array.isArray(filters) || filters.length === 0)
        return null;
      return function(r2, g, b, a2) {
        if (a2 === 0)
          return false;
        for (var i2 = 0; i2 < filters.length; i2++) {
          if (!filters[i2](r2, g, b, a2))
            return false;
        }
        return true;
      };
      ...
      function() {
        ...
        ImageBase2.prototype.applyFilter = function(filter) {
          ...
          if (typeof filter === "function") {
            ...
            var n2 = pixels.length / 4;
            var offset = void 0, r2 = void 0, g = void 0, b = void 0, a2 = void 0;
...
var require_browser = __commonJS({
  "node_modules/node-vibrant/lib/image/browser.js"(exports) {
    ...
    function isRelativeUrl(url) {
      ...
      return u2.protocol === null && u2.host === null && u2.port === null;
    }
...
var require_lodash2 = __commonJS({
  "node_modules/lodash.invoke/index.js"(exports, module) {
    var FUNC_ERROR_TEXT = "Expected a function";
    var HASH_UNDEFINED = "__lodash_hash_undefined__";
    var INFINITY = 1 / 0;
    var funcTag = "[object Function]";
...
// node_modules/@roylee1997/react-palette/dist/react-palette.mjs
var import_node_vibrant = __toESM(require_browser2(), 1);
...
var c = function(a2) {
  try {
    return Promise.resolve(import_node_vibrant.default.from(a2).getPalette()).then(function(e2) {
      return Object.keys(e2).reduce(function(a3, n2) {
        var c2;
        return o({}, a3, ((c2 = {})[(0, import_lodash.default)(n2)] = (0, import_lodash2.default)(e2, [n2, "getHex"]), c2));
      }, {});
    });
  } catch (e2) {
...
var i = { loading: true, data: {}, error: void 0 };
function l(e2, t2) {
  switch (t2.type) {
    case "getPalette":
      return i;
    case "resolvePalette":
      return o({}, e2, { data: t2.payload, loading: false });
    case "rejectPalette":
      return o({}, e2, { error: t2.payload, loading: false });
  }
}
function u(e2) {
  var t2 = import_react.default.useReducer(l, i), r2 = t2[0], n2 = t2[1];
  return import_react.default.useEffect(function() {
    n2({ type: "getPalette" }), c(e2).then(function(e3) {
      n2({ type: "resolvePalette", payload: e3 });
    }).catch(function(e3) {
      n2({ type: "rejectPalette", payload: e3 });
    });
  }, [e2]), r2;
}
var s = function(e2) {
  var t2 = e2.children, r2 = u(e2.src);
  return (0, import_react.cloneElement)(t2, { palette: r2 });
};
export {
  s as Palette,
  s as default,
...
*/
//# sourceMappingURL=@roylee1997_react-palette.js.map
